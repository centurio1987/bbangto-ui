...
export const organicFluidBlobStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Organic_Fluid_Blob_01',
    trendIndex: 34,
    family: 'expressive-energetic',
    priority: 'P1',
    summary: '바이오모픽 블롭·리본·스우시의 매끈한 곡선 + 시안→마젠타→코랄 다색 유체 그라디언트, 평면적이며 hover 블롭 모핑이 시그니처.',
    tags: ['gradient', 'organic', 'rounded', 'vivid', 'flat', 'playful', 'animated'],
    mood: { formality: 2, energy: 4, warmth: 3, density: 2, ornament: 4 },
    characteristics: {
      cornerRadius: 'round',
      borderWeight: 'thin',
      shadow: 'none',
    ...
    domains: ['creative-agency', 'marketing', 'landing', 'portfolio', 'entertainment'],
    useWhen: [
      '창의적·표현적 브랜드 랜딩에서 유기적 곡선과 다색 그라디언트로 개성을 낼 때 쓴다.',
      '부드럽고 친근한 인상의 마케팅·에이전시 사이트를 만들 때 쓴다.',
      'hover 블롭 모핑 같은 유체 인터랙션으로 생동감을 주고 싶을 때 쓴다.',
      '그림자 없이 색의 흐름만으로 깊이를 표현하고 싶을 때 쓴다.',
    ],
    avoidWhen: [
      '데이터 밀도 높은 대시보드·관리 UI처럼 각지고 정돈된 구조가 필요할 때 피한다.',
      '금융·엔터프라이즈처럼 절제된 격식과 중립 톤이 우선일 때 피한다.',
      '그라디언트 색면 위 본문 가독성이 핵심인 텍스트 중심 화면에는 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['claymorphism-playful-01', 'aurora-gradient-01', 'ai-surreal-gradient3d-01'],
  },
};
