...
export const heritageFolkOrnamentStyleGuide: StyleGuide = {
  ...
  meta: {
    ...
    family: 'nostalgia',
    priority: 'P3',
    summary: '따뜻한 흙빛 코랄 그라운드를 대칭 민속 꽃·새 모티프와 스캘럽 장식 보더가 감싸는, 거의 평면인 공예 오너먼트.',
    tags: ['vivid', 'light', 'rounded', 'organic', 'serif', 'textured', 'retro', 'maximal'],
    mood: { formality: 2, energy: 4, warmth: 5, density: 4, ornament: 5 },
    characteristics: {
      cornerRadius: 'soft',
      borderWeight: 'bold',
      shadow: 'none',
    ...
    domains: ['marketing', 'landing', 'ecommerce', 'creative-agency', 'portfolio'],
    useWhen: [
      '민속·공예·헤리티지 브랜드나 축제·초대장 랜딩을 만들 때 쓴다.',
      '굿즈·수공예 제품 카탈로그처럼 따뜻한 손맛과 장식성이 필요할 때 쓴다.',
      '대칭 꽃·새 모티프와 장식 보더로 페이지 전체에 공예 정체성을 입히고 싶을 때 쓴다.',
      '고채도 흙빛 팔레트로 따뜻하고 풍성한 분위기를 낼 때 쓴다.',
    ],
    avoidWhen: [
      '데이터 밀도 높은 대시보드·관리 UI처럼 절제와 가독성이 최우선일 때 피한다.',
      'B2B SaaS·핀테크처럼 중립적 신뢰감이 필요할 때 피한다.',
      '장식을 걷어낸 미니멀·차분한 인상이 목표일 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['romantic-botanical-01', 'ukiyoe-woodblock-01', 'retro70s-warm-01'],
  },
};
