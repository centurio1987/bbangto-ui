...
export const kawaiiPastelStyleGuide: StyleGuide = {
  ...
  meta: {
    ...
    priority: 'P3',
    summary: '화이트 베이스 위 베이비핑크·민트·라벤더 파스텔, 둥글둥글 표면과 볼터치 글로우·마스코트로 귀여운 인상을 내는 UI.',
    tags: ['light', 'pastel', 'rounded', 'organic', 'playful', 'animated', 'gradient', 'airy'],
    ...
    domains: ['kids', 'social', 'ecommerce', 'education', 'entertainment'],
    useWhen: [
      '키즈·커뮤니티·굿즈 스토어처럼 친근하고 귀여운 인상이 필요할 때 쓴다.',
      '온보딩·환영 화면에서 말랑하고 다정한 무드를 주고 싶을 때 쓴다.',
      '마스코트·캐릭터 브랜드와 파스텔 톤을 맞추고 싶을 때 쓴다.',
    ],
    avoidWhen: [
      'B2B·핀테크처럼 전문성과 신뢰감이 우선일 때 피한다.',
      '고밀도 데이터 대시보드나 격식 있는 기업 UI에는 피한다.',
      '강렬한 고대비·임팩트가 핵심인 화면에는 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['claymorphism-playful-01', 'romantic-botanical-01', 'naive-doodle-01'],
  },
};
