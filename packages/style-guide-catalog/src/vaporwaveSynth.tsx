...
export const vaporwaveSynthStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Vaporwave_Synth_01',
    trendIndex: 11,
    family: 'nostalgia',
    priority: 'P2',
    summary: '딥퍼플 캔버스 위 네온 핑크·시안 글로우, 80s 석양 그라디언트와 퍼스펙티브 그리드, CRT 스캔라인의 신스웨이브.',
    tags: ['dark', 'neon', 'gradient', 'vivid', 'retro', 'futuristic', 'mono', 'animated'],
    ...
    domains: ['entertainment', 'gaming', 'creative-agency', 'marketing', 'portfolio'],
    useWhen: [
      '음악·나이트라이프·레트로 이벤트 랜딩에 80s 신스웨이브 무드가 필요할 때 쓴다.',
      '네온 글로우로 강한 레트로 미래 인상과 몰입감을 주고 싶을 때 쓴다.',
      '다크 배경 위 비비드한 개성으로 브랜드를 각인시킬 때 쓴다.',
    ],
    avoidWhen: [
      'B2B 대시보드·문서처럼 가독성과 절제가 우선일 때 피한다.',
      '저모션·저자극이 요구되는 접근성 민감 환경에서 피한다(글리치·스캔라인).',
      '장시간 읽는 본문 중심 서비스에서 피한다(네온 피로).',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['y2k-futurism-01', 'cyberpunk-hud-01', 'radiant-glow-dark-01'],
  },
};
