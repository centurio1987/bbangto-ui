...
export const humanistImperfectStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Humanist_Imperfect_01',
    trendIndex: 27,
    family: 'expressive-energetic',
    priority: 'P2',
    summary: '손그림 + 유기 곡선 + 의도적 결함 레터폼, 웜 페이퍼 배경 + 어스/잉크 톤의 감성 주도 진정성 UI.',
    tags: ['light', 'muted', 'textured', 'grainy', 'organic', 'hand-drawn', 'rounded'],
    mood: { formality: 2, energy: 2, warmth: 5, density: 2, ornament: 3 },
    characteristics: {
      cornerRadius: 'round',
      borderWeight: 'bold',
      shadow: 'none',
    ...
    domains: ['portfolio', 'blog', 'marketing', 'creative-agency', 'editorial'],
    useWhen: [
      '수공예·로컬 브랜드처럼 사람 냄새와 진정성을 전면에 내세울 때 쓴다.',
      '개인 포트폴리오·블로그에서 따뜻하고 친근한 인상을 줄 때 쓴다.',
      '스토리텔링 중심 마케팅 랜딩에서 손때 묻은 감성이 필요할 때 쓴다.',
      '반듯한 그리드보다 유기적 온기와 손그림 질감을 우선할 때 쓴다.',
    ],
    avoidWhen: [
      '데이터 밀도 높은 대시보드·엔터프라이즈 관리 UI에는 피한다.',
      '금융·의료처럼 정밀함과 절제된 신뢰의 톤이 필요할 때 피한다.',
      '정보량이 많아 비틀림·손글씨가 가독성과 구조를 해칠 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['naive-doodle-01', 'scandi-warm-01', 'tactile-texture-01'],
  },
};
