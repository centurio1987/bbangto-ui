...
export const bentoModularStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Bento_Modular_01',
    trendIndex: 24,
    family: 'flat-systematic',
    priority: 'P1',
    summary: '도시락형 모듈 그리드 + 둥근 타일 + soft elevation, 인디고/틸 액센트의 비대칭·균형 레이아웃.',
    tags: ['light', 'rounded', 'grid', 'geometric', 'minimal', 'airy'],
    mood: { formality: 4, energy: 2, warmth: 2, density: 3, ornament: 2 },
    characteristics: {
      cornerRadius: 'round',
      borderWeight: 'thin',
      shadow: 'soft',
    ...
    domains: ['dashboard', 'saas', 'portfolio', 'marketing', 'landing'],
    useWhen: [
      '대시보드·개요 화면을 크고 작은 모듈 타일로 정리할 때 쓴다.',
      '여러 지표·기능을 한 화면에 균형 있게 배치하고 싶을 때 쓴다.',
      '제품 랜딩·포트폴리오의 feature 그리드를 모듈로 구성할 때 쓴다.',
    ],
    avoidWhen: [
      '긴 글·기사처럼 선형 읽기 흐름이 핵심일 때 피한다.',
      '강한 개성·표현적 임팩트가 필요한 브랜드 랜딩엔 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['minimal-saas-01', 'flat-material-01'],
  },
};
