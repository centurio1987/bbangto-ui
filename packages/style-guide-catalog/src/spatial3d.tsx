...
export const spatial3dStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Spatial_3D_01',
    trendIndex: 26,
    family: 'depth-material',
    priority: 'P3',
    summary: '딥 다크 + 라이팅 음영, 포인터 반응 깊이·시차(틸트)를 CSS 3D transform으로 모사한 공간 UI.',
    tags: ['dark', 'depth', 'gradient', 'rounded', 'animated', 'futuristic', 'glossy'],
    mood: { formality: 3, energy: 3, warmth: 2, density: 2, ornament: 3 },
    characteristics: {
      cornerRadius: 'soft',
      borderWeight: 'thin',
      shadow: 'glow',
    ...
    domains: ['marketing', 'landing', 'portfolio', 'creative-agency', 'ecommerce'],
    useWhen: [
      '제품 쇼케이스·랜딩 Hero에서 3D 오브젝트로 시선을 끌 때 쓴다.',
      '포인터 반응 깊이·시차로 인터랙티브한 공간감을 주고 싶을 때 쓴다.',
      'AR 프리뷰·인터랙티브 스토리처럼 몰입형 연출이 핵심일 때 쓴다.',
      '다크 배경에 라이팅 음영으로 프리미엄 테크 인상을 줄 때 쓴다.',
    ],
    avoidWhen: [
      '정보 밀도 높은 대시보드·문서처럼 정적 가독성이 우선일 때 피한다.',
      '저사양·성능 예산이 빠듯하거나 정적 폴백을 마련하기 어려울 때 피한다.',
      'prefers-reduced-motion 비중이 높아 모션을 줄여야 할 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['ai-surreal-gradient3d-01', 'glassmorphism-aurora-01', 'neumorphism-soft-01'],
  },
};
