...
export const memphisPostmodernStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Memphis_Postmodern_01',
    trendIndex: 12,
    family: 'nostalgia',
    priority: 'P3',
    summary: '밝은 크림 위 고채도 핑크·시안·노랑 충돌과 지그재그·물방울·테리조 패턴, 굵은 검정 윤곽·하드 오프셋 그림자의 포스트모던 표면.',
    tags: ['vivid', 'playful', 'maximal', 'retro', 'geometric', 'textured', 'high-contrast', 'pastel'],
    ...
    domains: ['creative-agency', 'marketing', 'portfolio', 'entertainment', 'landing'],
    useWhen: [
      '브랜드에 경쾌하고 개성 강한 포스트모던 인상을 주고 싶을 때 쓴다.',
      '크리에이티브 에이전시·이벤트·전시 랜딩처럼 시각적 임팩트가 우선일 때 쓴다.',
      '고채도 색 충돌과 패턴으로 놀이·활기를 표현하고 싶을 때 쓴다.',
    ],
    avoidWhen: [
      '데이터 밀도 높은 대시보드·업무 도구처럼 차분함이 필요할 때 피한다.',
      '금융·의료처럼 절제와 신뢰가 우선인 도메인에서는 피한다.',
      '장시간 읽는 본문 중심 문서에서 시각 피로가 우려될 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['neobrutalism-editorial-01', 'maximalism-dopamine-01', 'y2k-futurism-01'],
  },
};
