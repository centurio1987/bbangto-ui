...
export const scandiWarmStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Scandi_Warm_01',
    trendIndex: 22,
    family: 'refined-luxury',
    priority: 'P2',
    summary: '따뜻한 오프화이트 위 우드톤 주조 + 세이지 절제 액센트, 부드러운 라운드와 미세한 종이 결의 북유럽 미니멀.',
    tags: ['light', 'muted', 'rounded', 'textured', 'airy', 'minimal', 'mono'],
    ...
    domains: ['ecommerce', 'portfolio', 'marketing', 'blog', 'editorial'],
    useWhen: [
      '라이프스타일·커머스 브랜드에 따뜻하고 차분한 인상을 줄 때 쓴다.',
      '여백과 자연 톤으로 편안한 미니멀리즘을 원할 때 쓴다.',
      '포트폴리오·룩북처럼 콘텐츠를 조용히 돋보이게 할 때 쓴다.',
      '저채도 우드/세이지 팔레트로 온기를 전하고 싶을 때 쓴다.',
    ],
    avoidWhen: [
      '강한 대비·임팩트나 고에너지 표현이 필요할 때 피한다.',
      '테크·핀테크처럼 차갑고 정밀한 인상이 우선일 때 피한다.',
      '화려한 색·장식으로 시선을 끌어야 할 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['retro70s-warm-01', 'humanist-imperfect-01'],
  },
};
