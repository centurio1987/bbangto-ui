...
export const halftoneGlitchColorsepStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Halftone_Glitch_Colorsep_01',
    trendIndex: 42,
    family: 'tech-dark',
    priority: 'P2',
    summary: 'CMYK 망점 스크린 + 적·녹 채널 색분해 글리치, near-black 다크 베이스 + 2~3색 한정 잉크의 인쇄 오정합 포스터 미학.',
    tags: ['dark', 'vivid', 'sharp', 'grainy', 'textured', 'typographic', 'mono', 'animated'],
    mood: { formality: 2, energy: 4, warmth: 2, density: 4, ornament: 4 },
    characteristics: {
      cornerRadius: 'sharp',
      borderWeight: 'thin',
      shadow: 'hard',
    ...
    domains: ['creative-agency', 'portfolio', 'editorial', 'marketing', 'entertainment'],
    useWhen: [
      '음악·전시·컬처 캠페인처럼 인쇄물 질감과 디지털 글리치를 뒤섞은 강한 개성이 필요할 때 쓴다.',
      '포스터형 히어로와 초대형 콘덴스트 헤드라인으로 시선을 압도하고 싶을 때 쓴다.',
      '2~3색 한정 잉크로 언더그라운드 프린트·진(zine) 무드를 낼 때 쓴다.',
      '크리에이티브 에이전시·포트폴리오에서 실험적 편집 인상을 줄 때 쓴다.',
    ],
    avoidWhen: [
      '데이터 밀도 높은 대시보드·업무용 툴처럼 판독성이 최우선일 때 피한다.',
      '신뢰·정제된 기업/핀테크 톤이 필요할 때 피한다.',
      '적록색맹 비중이 크고 색분해 어긋남이 정보 전달에 관여할 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['halftone-dot-print-01', 'glitch-distortion-01', 'risograph-print-01'],
  },
};
