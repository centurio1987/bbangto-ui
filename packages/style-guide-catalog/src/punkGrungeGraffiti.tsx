...
export const punkGrungeGraffitiStyleGuide: StyleGuide = {
  ...
  meta: {
    ...
    priority: 'P2',
    summary: '제록스 하프톤·찢긴 가장자리·스프레이/낙서가 그리드를 깨는 반정제 카오스 콜라주, 오프블랙 + 형광 스폿(옐로/마젠타/레드) 충돌.',
    tags: ['raw', 'sharp', 'textured', 'grainy', 'high-contrast', 'neon', 'hand-drawn', 'maximal', 'asymmetric'],
    ...
    domains: ['creative-agency', 'entertainment', 'portfolio', 'marketing', 'landing'],
    useWhen: [
      '음악·서브컬처·이벤트처럼 반항적이고 시끄러운 개성이 필요할 때 쓴다.',
      '진(zine)·포스터·굿즈처럼 손으로 찢어 붙인 콜라주 질감을 원할 때 쓴다.',
      '크리에이티브 에이전시·아티스트 포트폴리오에서 강한 인상을 남기고 싶을 때 쓴다.',
    ],
    avoidWhen: [
      '신뢰·정밀이 중요한 금융·의료·기업 대시보드에는 피한다.',
      '높은 정보 밀도와 장시간 가독성이 필요한 제품 UI에는 피한다.',
      '차분하고 절제된 미니멀 톤이 요구될 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['collage-scrapbook-01', 'neobrutalism-editorial-01', 'mixed-media-collage-01'],
  },
};
