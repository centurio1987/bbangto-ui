...
export const ukiyoeWoodblockStyleGuide: StyleGuide = {
  ...
  meta: {
    ...
    family: 'nostalgia',
    priority: 'P2',
    summary: '쌀종이 배경 + 채도 낮은 흙빛 평면 색면 + 먹빛 윤곽선과 여백(ma) + 붉은 낙관 도장의 전통 목판화 미학.',
    tags: ['light', 'muted', 'flat', 'textured', 'serif', 'airy', 'asymmetric', 'retro'],
    ...
    domains: ['portfolio', 'editorial', 'blog', 'creative-agency', 'marketing'],
    useWhen: [
      '동양·전통 미학의 서정 풍경을 담은 포트폴리오·룩북을 만들 때 쓴다.',
      '채도 낮은 흙빛 팔레트로 차분하고 고요한 분위기를 낼 때 쓴다.',
      '평면 색면과 먹선·여백으로 회화적 위계를 세우고 싶을 때 쓴다.',
      '브랜드 스토리·갤러리처럼 이미지 슬롯 중심 편집이 필요할 때 쓴다.',
    ],
    avoidWhen: [
      '데이터 밀도 높은 대시보드·관리 UI처럼 기능 우선일 때 피한다.',
      '글로시·네온·3D 입체감이나 강렬한 비비드 색이 필요할 때 피한다.',
      '저채도 흙빛만으로 본문 대비가 무너질 위험이 클 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['scandi-warm-01', 'retro70s-warm-01', 'heritage-folk-ornament-01'],
  },
};
