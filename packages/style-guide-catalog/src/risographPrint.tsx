...
export const risographPrintStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Risograph_Print_01',
    trendIndex: 29,
    family: 'nostalgia',
    priority: 'P1',
    summary: '웜 크림 종이 + 한정 스팟 잉크 2~3색 multiply 오버프린트, 분판 미스레지스트레이션과 그레인/망점의 평면 인쇄소 질감.',
    tags: ['light', 'vivid', 'textured', 'grainy', 'retro', 'sharp', 'typographic'],
    mood: { formality: 2, energy: 3, warmth: 4, density: 3, ornament: 4 },
    characteristics: {
      cornerRadius: 'sharp',
      borderWeight: 'thin',
      shadow: 'none',
    ...
    domains: ['creative-agency', 'editorial', 'marketing', 'portfolio', 'blog'],
    useWhen: [
      '포스터·룩북·인쇄물처럼 손맛 있는 아날로그 질감이 핵심일 때 쓴다.',
      '크리에이티브 에이전시·전시·문화 행사 홍보물에 개성을 줄 때 쓴다.',
      '한정 스팟 잉크 오버프린트로 제3색과 분판 어긋남을 연출하고 싶을 때 쓴다.',
      '인디 출판·소규모 브랜드의 편집 표지 무드가 필요할 때 쓴다.',
    ],
    avoidWhen: [
      '데이터 밀도 높은 대시보드·관리 UI처럼 정밀 정합과 가독성이 최우선일 때 피한다.',
      '풀컬러 사진·부드러운 그라디언트·드롭섀도가 중심인 디자인에는 피한다.',
      '기업 신뢰감·미니멀 절제가 우선인 B2B SaaS에는 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['halftone-dot-print-01', 'tactile-texture-01', 'halftone-glitch-colorsep-01'],
  },
};
