...
export const collageScrapbookStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Collage_Scrapbook_01',
    trendIndex: 16,
    family: 'expressive-energetic',
    priority: 'P3',
    summary: '크라프트지 위 손그림 보더·폴라로이드 테이프 컷아웃·스티커 라벨로 손으로 꾸민 스크랩북 페이지.',
    tags: ['light', 'textured', 'hand-drawn', 'playful', 'organic', 'asymmetric', 'retro'],
    mood: { formality: 1, energy: 3, warmth: 5, density: 3, ornament: 4 },
    characteristics: {
      cornerRadius: 'soft',
      borderWeight: 'bold',
      shadow: 'hard',
    ...
    domains: ['portfolio', 'blog', 'creative-agency', 'kids', 'education'],
    useWhen: [
      '개인 블로그·포트폴리오에 손으로 꾸민 따뜻한 인상을 줄 때 쓴다.',
      '사진·메모·컬렉션을 콜라주처럼 붙여 보여주고 싶을 때 쓴다.',
      '키즈·교육·취미 콘텐츠에 놀이적이고 친근한 질감을 줄 때 쓴다.',
      '회고·무드보드처럼 아날로그 감성을 강조할 때 쓴다.',
    ],
    avoidWhen: [
      '데이터 밀도 높은 대시보드·기업 SaaS처럼 정밀·중립이 필요할 때 피한다.',
      '엄격한 정렬 그리드와 균일한 반경이 요구되는 UI에는 피한다.',
      '핀테크·의료처럼 격식과 신뢰가 최우선일 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['mixed-media-collage-01', 'naive-doodle-01', 'tactile-texture-01'],
  },
};
