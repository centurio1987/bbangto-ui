...
export const flatMaterialStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Flat_Material_01',
    trendIndex: 5,
    family: 'flat-systematic',
    priority: 'P1',
    summary: 'Material You 키컬러 파생 톤 시스템 + 부드러운 elevation 그림자, 둥근 pill 액션과 상태 레이어의 소비자 앱 UI.',
    tags: ['light', 'rounded', 'flat', 'depth', 'pastel', 'mono'],
    mood: { formality: 3, energy: 2, warmth: 3, density: 3, ornament: 2 },
    characteristics: {
      cornerRadius: 'round',
      borderWeight: 'thin',
      shadow: 'soft',
    ...
    domains: ['saas', 'ecommerce', 'healthcare', 'education', 'social'],
    useWhen: [
      '안드로이드/모바일 앱 감성의 일관된 디자인 시스템이 필요할 때 쓴다.',
      '키컬러 하나로 표면·강조 톤을 자동 파생시키고 싶을 때 쓴다.',
      '보더 대신 elevation 그림자로 위계를 표현하고 싶을 때 쓴다.',
      '친근하고 접근성 좋은 소비자 제품 UI를 만들 때 쓴다.',
    ],
    avoidWhen: [
      '날카로운 각·강한 브랜드 개성으로 차별화가 필요할 때 피한다.',
      '고밀도 데이터·표 위주의 조밀한 관리 UI엔 과한 여백일 수 있어 피한다.',
      '다크/네온 테크 무드가 핵심일 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['minimal-saas-01', 'neumorphism-soft-01'],
  },
};
