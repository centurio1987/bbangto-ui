...
export const gothicMedievalDigitalStyleGuide: StyleGuide = {
  ...
  meta: {
    ...
    family: 'tech-dark',
    priority: 'P1',
    summary: 'near-black·옥스블러드 + 뮤트 골드에 단일 네온 블록, 블랙레터·문장·왁스 인장이 디지털 그리드와 충돌하는 다크 신비주의.',
    tags: ['dark', 'neon', 'sharp', 'serif', 'grainy', 'textured', 'high-contrast', 'serious'],
    mood: { formality: 4, energy: 4, warmth: 3, density: 3, ornament: 4 },
    characteristics: {
      cornerRadius: 'sharp',
      borderWeight: 'thin',
      shadow: 'hard',
    ...
    domains: ['gaming', 'entertainment', 'creative-agency', 'crypto-web3', 'landing'],
    useWhen: [
      '다크 판타지·오컬트·중세 세계관의 게임/엔터 랜딩을 만들 때 쓴다.',
      '블랙레터 헤드와 문장·왁스 인장 도상으로 의식적(ceremonial) 무게를 주고 싶을 때 쓴다.',
      '근-블랙 화면에 단 하나의 네온 블록으로 극적 위계의 정점을 세우고 싶을 때 쓴다.',
      'web3·NFT 컬렉션처럼 신비주의와 디지털 충돌 미학이 어울릴 때 쓴다.',
    ],
    avoidWhen: [
      '가독성·정보 밀도가 최우선인 제품 대시보드·설정 UI에는 피한다.',
      'artdeco·darkluxe처럼 정제된 럭셔리 톤이 필요할 때는 피한다.',
      '밝고 경쾌한 소비자·키즈·헬스케어 톤이 핵심일 때는 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['darkluxe-editorial-01', 'cyberpunk-hud-01', 'radiant-glow-dark-01'],
  },
};
