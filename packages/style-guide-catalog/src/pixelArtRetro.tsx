...
export const pixelArtRetroStyleGuide: StyleGuide = {
  ...
  meta: {
    ...
    family: 'nostalgia',
    priority: 'P2',
    summary: '의도적 저해상 8비트 도트 미감 — 정수 픽셀 그리드에 스냅된 블록 타이포·직각 모서리·blur 0 하드 도트 그림자, CRT 다크 베이스 고채도 원색.',
    tags: ['retro', 'dark', 'vivid', 'sharp', 'geometric', 'mono', 'grid', 'playful'],
    mood: { formality: 2, energy: 4, warmth: 2, density: 3, ornament: 3 },
    characteristics: {
      cornerRadius: 'sharp',
      borderWeight: 'bold',
      shadow: 'hard',
    ...
    domains: ['gaming', 'entertainment', 'portfolio', 'creative-agency', 'landing'],
    useWhen: [
      '레트로 게임·아케이드 향수를 앞세운 UI를 만들 때 쓴다.',
      '8비트 도트 미감으로 강한 개성·놀이 에너지를 줄 때 쓴다.',
      '게임·엔터·크리에이티브 포트폴리오 랜딩에 쓴다.',
    ],
    avoidWhen: [
      '장문 본문 가독성·정보 밀도가 최우선인 관리 UI에는 피한다.',
      '기업·금융처럼 절제된 신뢰감이 필요할 때 피한다.',
      '부드러운 곡선·그라디언트 기반 브랜드에는 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['terminal-mono-01', 'y2k-futurism-01', 'vaporwave-synth-01'],
  },
};
