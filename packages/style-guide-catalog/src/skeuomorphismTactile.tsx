...
export const skeuomorphismTactileStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Skeuomorphism_Tactile_01',
    trendIndex: 4,
    family: 'depth-material',
    priority: 'P3',
    summary: '따뜻한 가죽·노트 베이지 표면 + 베벨 하이라이트·안쪽 그림자로 빚은 물리적 촉각 스큐어모피즘, 누르면 들어가는 버튼.',
    tags: ['textured', 'depth', 'rounded', 'glossy', 'gradient', 'muted', 'retro'],
    mood: { formality: 3, energy: 2, warmth: 5, density: 3, ornament: 4 },
    characteristics: {
      cornerRadius: 'soft',
      borderWeight: 'thin',
      shadow: 'hard',
    ...
    domains: ['portfolio', 'entertainment', 'creative-agency', 'blog', 'marketing'],
    useWhen: [
      '노트·메모·오디오 콘솔처럼 실물 은유로 어포던스를 강화할 때 쓴다.',
      '가죽·종이 질감의 따뜻하고 촉각적인 인상을 주고 싶을 때 쓴다.',
      '레트로·향수 감성의 포트폴리오나 브랜드 경험을 만들 때 쓴다.',
      '버튼이 실제로 눌리는 물리 피드백으로 재미를 더할 때 쓴다.',
    ],
    avoidWhen: [
      '정보 밀도 높은 대시보드·데이터 UI에서 가독성이 우선일 때 피한다.',
      '가볍고 빠른 로딩·모던 미니멀이 요구될 때 피한다.',
      '넓은 화면에 질감을 남발해 일관성·유지비가 커질 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['neumorphism-soft-01', 'claymorphism-playful-01', 'tactile-texture-01'],
  },
};
