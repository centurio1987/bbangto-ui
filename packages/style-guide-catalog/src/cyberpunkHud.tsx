...
export const cyberpunkHudStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Cyberpunk_Hud_01',
    trendIndex: 18,
    family: 'tech-dark',
    priority: 'P2',
    summary: '다크 베이스 + 네온 엣지·스캔라인 + HUD 프레임의 사이버펑크 인터페이스.',
    tags: ['dark', 'neon', 'high-contrast', 'futuristic', 'technical', 'mono', 'vivid', 'animated'],
    ...
    domains: ['gaming', 'entertainment', 'crypto-web3', 'dashboard', 'landing'],
    useWhen: [
      '게임·e스포츠·스트리밍처럼 몰입형 다크 인터페이스가 필요할 때 쓴다.',
      'crypto/web3·테크 제품에서 미래적·하이테크 인상을 줄 때 쓴다.',
      '실시간 데이터·HUD 오버레이 감성의 대시보드에 쓴다.',
    ],
    avoidWhen: [
      '접근성·장시간 가독성이 최우선인 문서/폼에는 피한다.',
      '차분·중립·기업 신뢰 톤이 필요할 때 피한다.',
      'prefers-reduced-motion 사용자 비중이 큰 서비스에는 모션·글로우 과다로 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['terminal-mono-01', 'aurora-gradient-01', 'radiant-glow-dark-01'],
  },
};
