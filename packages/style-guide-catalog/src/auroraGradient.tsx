...
export const auroraGradientStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Aurora_Gradient_01',
    trendIndex: 20,
    family: 'tech-dark',
    priority: 'P2',
    summary: '딥 다크 위 다점 메시/오로라 그라디언트 배경 + 부유 글로우 오브, 그라디언트 fill 버튼·다크 글래스 표면(AI/SaaS 랜딩).',
    tags: ['dark', 'gradient', 'glass', 'vivid', 'depth', 'futuristic', 'animated', 'rounded'],
    ...
    domains: ['saas', 'marketing', 'landing', 'crypto-web3', 'creative-agency'],
    useWhen: [
      'AI·SaaS 제품 랜딩에서 미래적이고 몰입감 있는 첫인상을 줄 때 쓴다.',
      '딥 다크 위 빛나는 메시 그라디언트로 시선을 끄는 히어로가 필요할 때 쓴다.',
      '웹3·크립토처럼 첨단·역동 이미지를 강조하고 싶을 때 쓴다.',
    ],
    avoidWhen: [
      '데이터 밀도 높은 대시보드·테이블 UI에는 피한다(가독성 저하).',
      '문서·블로그처럼 긴 본문 가독성이 최우선일 때 피한다.',
      '절제된 기업/포멀 톤이나 라이트 기본이 요구될 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['glassmorphism-aurora-01', 'radiant-glow-dark-01', 'ai-surreal-gradient3d-01'],
  },
};
