...
export const retro70sWarmStyleGuide: StyleGuide = {
  ...
  meta: {
    ...
    family: 'nostalgia',
    priority: 'P3',
    summary: '크림 베이스 위 머스타드·테라코타·올리브 어스톤, 필름 그레인, 알약형·아치 라운드의 70년대 따뜻한 레트로.',
    tags: ['light', 'retro', 'grainy', 'textured', 'rounded', 'playful', 'vivid'],
    mood: { formality: 2, energy: 3, warmth: 5, density: 3, ornament: 3 },
    characteristics: {
      cornerRadius: 'round',
      borderWeight: 'bold',
      shadow: 'hard',
    ...
    domains: ['marketing', 'landing', 'portfolio', 'blog', 'creative-agency'],
    useWhen: [
      '70년대 빈티지·레트로 무드의 브랜드 Hero·랜딩을 만들 때 쓴다.',
      '따뜻한 어스톤과 그루비 라운드로 친근하고 아날로그한 인상을 주고 싶을 때 쓴다.',
      '카페·베이커리·라이프스타일처럼 손맛과 온기를 강조할 때 쓴다.',
    ],
    avoidWhen: [
      '데이터 밀도 높은 대시보드·엔터프라이즈 관리 UI에는 피한다.',
      '차갑고 미니멀한 테크·핀테크 신뢰 톤이 필요할 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['scandi-warm-01', 'risograph-print-01'],
  },
};
