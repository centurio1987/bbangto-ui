...
export const naiveDoodleStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Naive_Doodle_01',
    trendIndex: 50,
    family: 'expressive-energetic',
    priority: 'P3',
    summary: '비숙련 어린아이의 크레용 낙서·스크리블 — 원색 마커 다색, 삐뚤한 손그림 윤곽선, 화살표·동그라미 주석의 천진한 카오스.',
    tags: ['light', 'vivid', 'hand-drawn', 'playful', 'organic', 'textured', 'animated'],
    mood: { formality: 1, energy: 4, warmth: 4, density: 3, ornament: 4 },
    characteristics: {
      cornerRadius: 'round',
      borderWeight: 'bold',
      shadow: 'hard',
    ...
    domains: ['kids', 'education', 'marketing', 'creative-agency', 'landing'],
    useWhen: [
      '키즈·교육·커뮤니티처럼 천진하고 친근한 손그림 무드가 필요할 때 쓴다.',
      '이벤트·캠페인 랜딩이나 무드보드·포스터에서 놀이 같은 개성을 줄 때 쓴다.',
      '낙서 주석(화살표·동그라미)으로 헤드라인을 강조하고 싶을 때 쓴다.',
    ],
    avoidWhen: [
      '금융·기업 대시보드처럼 신뢰감과 정밀함이 우선일 때 피한다.',
      '고밀도 데이터·긴 본문 가독성이 핵심인 UI에서 피한다.',
      '절제된 미니멀·럭셔리 톤이 필요할 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['humanist-imperfect-01', 'kawaii-pastel-01'],
  },
};
