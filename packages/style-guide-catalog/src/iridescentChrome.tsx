...
export const iridescentChromeStyleGuide: StyleGuide = {
  ...
  meta: {
    ...
    priority: 'P3',
    summary: '근흑 무대 위 불투명 홀로그래픽 포일 + 액체 크롬 메탈 — 각도/인터랙션에 따라 시프트하는 이리데센트 광택.',
    tags: ['dark', 'gradient', 'glossy', 'rounded', 'depth', 'textured', 'futuristic', 'animated'],
    ...
    domains: ['creative-agency', 'portfolio', 'entertainment', 'marketing', 'landing'],
    useWhen: [
      'Hero·제품/굿즈 쇼케이스처럼 표면 광택이 주역이어야 할 때 쓴다.',
      '음악·이벤트 랜딩에서 미래적·프리미엄 무드를 낼 때 쓴다.',
      '무드보드·포트폴리오 갤러리에서 홀로그래픽 포일 질감을 강조할 때 쓴다.',
      '다크 무대 위에서 시프트하는 이리데센트 광택으로 시선을 끌 때 쓴다.',
    ],
    avoidWhen: [
      '본문 텍스트 밀도가 높은 대시보드·문서 UI일 때 피한다.',
      '엄격한 WCAG 대비·정적 화면이 요구될 때 피한다.',
      '절제된 기업 신뢰감이 우선일 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['frutiger-aero-glossy-01', 'glassmorphism-aurora-01', 'y2k-futurism-01'],
  },
};
