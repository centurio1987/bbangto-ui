...
export const tactileTextureStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Tactile_Texture_01',
    trendIndex: 28,
    family: 'expressive-energetic',
    priority: 'P2',
    summary: '퍼피·소프트·스퀴시 촉각 질감 + 하이퍼리얼 광택. 파스텔 톤·두툼한 radius·부드러운 이중 그림자, 누르면 쪼그라드는 말랑한 인터랙션.',
    tags: ['pastel', 'rounded', 'depth', 'glossy', 'textured', 'playful', 'animated'],
    mood: { formality: 2, energy: 3, warmth: 4, density: 2, ornament: 4 },
    characteristics: {
      cornerRadius: 'round',
      borderWeight: 'thin',
      shadow: 'soft',
    ...
    domains: ['kids', 'education', 'entertainment', 'marketing', 'landing'],
    useWhen: [
      '말랑한 촉각·놀이 감성이 첫인상을 좌우하는 랜딩·마케팅에 쓴다.',
      '키즈·교육·엔터처럼 친근하고 만지고 싶은 UI가 필요할 때 쓴다.',
      '버튼 누름 같은 인터랙션에 촉각적 스퀴시 피드백을 주고 싶을 때 쓴다.',
    ],
    avoidWhen: [
      '정보 밀도가 높은 대시보드·관리 화면에는 쓰지 않는다.',
      '기업·금융처럼 진중한 신뢰감이 우선일 때 피한다.',
      '강한 질감·그림자가 시각 노이즈가 될 데이터 집약 화면에서 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['claymorphism-playful-01', 'neumorphism-soft-01', 'kawaii-pastel-01'],
  },
};
