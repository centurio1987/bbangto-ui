...
export const y2kFuturismStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Y2K_Futurism_01',
    trendIndex: 10,
    family: 'nostalgia',
    priority: 'P2',
    summary: '크롬·실버 메탈 그라디언트 + 핑크·시안·라임 네온 글로우, 글로시 버블 폼의 미래주의 회고 UI.',
    tags: ['light', 'gradient', 'glossy', 'neon', 'vivid', 'rounded', 'futuristic', 'retro'],
    ...
    domains: ['marketing', 'landing', 'entertainment', 'creative-agency', 'portfolio'],
    useWhen: [
      'Y2K·레트로 미래주의 감성으로 강한 향수와 개성을 낼 때 쓴다.',
      '크롬·네온·글로시 표면으로 시선을 끄는 마케팅·랜딩·이벤트 페이지를 만들 때 쓴다.',
      '음악·엔터·크리에이티브 브랜드의 개성 있는 무드가 필요할 때 쓴다.',
    ],
    avoidWhen: [
      '데이터 밀도 높은 대시보드·관리 UI처럼 절제와 가독성이 우선일 때 피한다.',
      'B2B·핀테크처럼 신뢰감과 정보 위계가 핵심일 때 피한다.',
      '글로시 표면 위 장문 본문 가독성이 최우선일 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['vaporwave-synth-01', 'frutiger-aero-glossy-01', 'iridescent-chrome-01'],
  },
};
