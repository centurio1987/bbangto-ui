...
export const maximalismDopamineStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Maximalism_Dopamine_01',
    trendIndex: 15,
    family: 'expressive-energetic',
    priority: 'P2',
    summary: '밝은 캔버스 위 고채도 충돌색 + 대형 가변 타이포 + 겹침 레이아웃 + 두꺼운 보더·오프셋 그림자의 과잉 에너지 UI.',
    tags: ['vivid', 'maximal', 'playful', 'high-contrast', 'rounded', 'typographic', 'animated'],
    mood: { formality: 1, energy: 5, warmth: 4, density: 4, ornament: 5 },
    characteristics: {
      cornerRadius: 'round',
      borderWeight: 'bold',
      shadow: 'hard',
    ...
    domains: ['creative-agency', 'marketing', 'landing', 'entertainment', 'portfolio'],
    useWhen: [
      '브랜드 캠페인·이벤트 랜딩에서 강한 임팩트와 시선 집중이 필요할 때 쓴다.',
      '크리에이티브 에이전시·포트폴리오로 개성과 에너지를 과시할 때 쓴다.',
      '음악·엔터·팝 컬처처럼 과잉의 활기가 어울릴 때 쓴다.',
    ],
    avoidWhen: [
      '데이터 밀도 높은 대시보드·관리 UI처럼 가독성·절제가 우선일 때 피한다.',
      '금융·의료처럼 신뢰감과 차분함이 핵심일 때 피한다.',
      '장시간 읽는 본문 위주 콘텐츠에서 눈의 피로가 문제될 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['neobrutalism-editorial-01', 'memphis-postmodern-01'],
  },
};
