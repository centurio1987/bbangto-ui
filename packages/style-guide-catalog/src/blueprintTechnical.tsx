...
export const blueprintTechnicalStyleGuide: StyleGuide = {
  ...
  meta: {
    ...
    priority: 'P1',
    summary: '딥 블루 청사진 보드 + 8px 모눈 위 1px 라인 드로잉, 화살촉 치수선·번호 콜아웃의 엔지니어링 제도 도면 미학.',
    tags: ['dark', 'technical', 'grid', 'mono', 'sharp', 'geometric', 'high-contrast'],
    mood: { formality: 4, energy: 2, warmth: 1, density: 3, ornament: 2 },
    characteristics: {
      cornerRadius: 'sharp',
      borderWeight: 'thin',
      shadow: 'none',
    ...
    domains: ['dev-tools', 'portfolio', 'creative-agency', 'landing', 'docs'],
    useWhen: [
      '엔지니어링·건축·하드웨어처럼 제도(製圖)·설계 도면 감성이 필요할 때 쓴다.',
      '제품 구조나 시스템을 도해로 설명하는 기술 랜딩·포트폴리오에 쓴다.',
      '8px 모눈·치수선·콜아웃으로 정밀함과 전문성을 시각화하고 싶을 때 쓴다.',
      '딥 블루 다크 보드의 강한 개성으로 차별화가 필요할 때 쓴다.',
    ],
    avoidWhen: [
      '따뜻하고 부드러운 소비자·키즈·라이프스타일 톤이 필요할 때 피한다.',
      '풍부한 사진·그라디언트·입체 그림자가 핵심 비주얼일 때 피한다.',
      '정보 밀도 높은 범용 대시보드에서 중립적 가독성만 원할 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['swiss-international-01', 'minimal-saas-01', 'bauhaus-geometric-01'],
  },
};
