...
export const terminalMonoStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Terminal_Mono_01',
    trendIndex: 19,
    family: 'tech-dark',
    priority: 'P1',
    summary: '본문까지 모노스페이스 + 다크 콘솔 배경 + 포스포 그린 강조, 박스 보더·커서·각진 모서리의 터미널 미학.',
    tags: ['dark', 'mono', 'monochrome', 'sharp', 'technical', 'typographic', 'high-contrast'],
    mood: { formality: 3, energy: 2, warmth: 2, density: 3, ornament: 2 },
    characteristics: {
      cornerRadius: 'sharp',
      borderWeight: 'thin',
      shadow: 'none',
    ...
    domains: ['dev-tools', 'docs', 'landing', 'portfolio', 'crypto-web3'],
    useWhen: [
      '개발자 도구·CLI 데모·로그/모니터링 UI를 만들 때 쓴다.',
      '코드 블록·기술 문서에 콘솔 미학을 입히고 싶을 때 쓴다.',
      '해커·기술 지향 브랜드의 랜딩에서 개성을 줄 때 쓴다.',
    ],
    avoidWhen: [
      '넓은 소비자층 대상 마케팅 랜딩에서 친근함이 필요할 때 피한다.',
      '장문 본문 가독성이 최우선인 콘텐츠(모노 피로)일 때 피한다.',
      '따뜻하고 부드러운 무드가 필요할 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['cyberpunk-hud-01', 'blueprint-technical-01'],
  },
};
