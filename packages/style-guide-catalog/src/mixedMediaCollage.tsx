...
export const mixedMediaCollageStyleGuide: StyleGuide = {
  ...
  meta: {
    ...
    priority: 'P2',
    summary: '페이퍼 캔버스 위 사진·드로잉·3D를 듀오톤·그레인으로 통일한 레이어 콜라주 — 편집적 멀티미디어 합성 비주얼.',
    tags: ['textured', 'grainy', 'organic', 'asymmetric', 'hand-drawn', 'typographic', 'maximal'],
    ...
    domains: ['creative-agency', 'portfolio', 'editorial', 'marketing', 'landing'],
    useWhen: [
      '사진·일러스트·3D를 한 톤으로 녹여 하나의 합성 이미지처럼 보여줄 때 쓴다.',
      '룩북·캠페인·무드보드처럼 편집적 비주얼이 주인공인 화면에 쓴다.',
      '브랜드 어바웃·아티클 스프레드에서 다매체를 감각적으로 엮고 싶을 때 쓴다.',
      '크리에이티브 에이전시·포트폴리오의 표현적 개성이 필요할 때 쓴다.',
    ],
    avoidWhen: [
      '데이터 밀도 높은 대시보드·폼 중심 제품 UI에는 피한다.',
      'collage-scrapbook처럼 테이프·찢김 등 날것의 이음새 질감이 목표일 때 피한다.',
      '텍스트 가독성·명료한 정보 위계가 최우선일 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['collage-scrapbook-01', 'photo-type-editorial-01', 'editorial-magazine-01'],
  },
};
