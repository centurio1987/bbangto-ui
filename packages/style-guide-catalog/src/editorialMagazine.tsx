...
export const editorialMagazineStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Editorial_Magazine_01',
    trendIndex: 8,
    family: 'typographic-editorial',
    priority: 'P2',
    summary: 'warm paper 위 디스플레이 세리프 헤드라인 + serif 본문, 헤어라인 칼럼 규칙선의 잉크 온 페이퍼 편집 지면.',
    tags: ['light', 'serif', 'typographic', 'grid', 'high-contrast', 'airy', 'serious', 'sharp'],
    mood: { formality: 3, energy: 2, warmth: 4, density: 3, ornament: 2 },
    characteristics: {
      cornerRadius: 'sharp',
      borderWeight: 'thin',
      shadow: 'none',
    ...
    domains: ['editorial', 'blog', 'marketing', 'portfolio', 'creative-agency'],
    useWhen: [
      '긴 읽기·기사·매거진처럼 활자와 위계가 콘텐츠의 중심일 때 쓴다.',
      '세리프 헤드라인과 칼럼 규칙선으로 인쇄물 같은 편집 지면을 만들 때 쓴다.',
      '브랜드에 지적이고 고전적인 신뢰감을 주고 싶을 때 쓴다.',
    ],
    avoidWhen: [
      '제품 대시보드·앱 UI처럼 조밀한 데이터 조작이 핵심일 때 피한다.',
      '강렬한 색·모션으로 소비자 임팩트가 필요할 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aaa',
    ...
    related: ['darkluxe-editorial-01', 'photo-type-editorial-01', 'swiss-international-01'],
  },
};
