...
export const opArtKineticStyleGuide: StyleGuide = {
  ...
  meta: {
    ...
    priority: 'P3',
    summary: '고대비 흑백 + 코발트 액센트 1색, 압축 그로테스크 헤비 산세리프, 직각 기조. 평행선·줄무늬의 위상 드리프트가 만드는 옵티컬 운동감이 시그니처.',
    tags: ['high-contrast', 'monochrome', 'geometric', 'sharp', 'kinetic', 'typographic', 'vivid', 'flat'],
    mood: { formality: 3, energy: 4, warmth: 1, density: 3, ornament: 3 },
    characteristics: {
      cornerRadius: 'sharp',
      borderWeight: 'bold',
      shadow: 'none',
    ...
    domains: ['creative-agency', 'portfolio', 'marketing', 'landing', 'entertainment'],
    useWhen: [
      '전시·포스터·브랜드 캠페인처럼 강한 시각적 임팩트가 필요할 때 쓴다.',
      '크리에이티브 에이전시·포트폴리오 히어로에 옵티컬 착시로 이목을 끌 때 쓴다.',
      '고대비 흑백 + 단일 강채도 액센트의 절제된 대담함을 원할 때 쓴다.',
      '이벤트 랜딩·갤러리 그리드에 리듬감 있는 줄무늬 변주를 쓰고 싶을 때 쓴다.',
    ],
    avoidWhen: [
      '본문·폼·표 같은 고밀도 정보 UI에는 피한다(줄무늬가 가독을 해친다).',
      '시각 피로·편두통·발작 위험을 낮춰야 하는 접근성 민감 서비스에는 피한다.',
      'SaaS 대시보드·차분한 기업 UI처럼 조용한 신뢰감이 우선일 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['bauhaus-geometric-01', 'kinetic-typography-01', 'warped-checkerboard-01'],
  },
};
