...
export const claymorphismPlayfulStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Claymorphism_Playful_01',
    trendIndex: 3,
    family: 'depth-material',
    priority: 'P2',
    summary: '밝은 라벤더 위 파스텔 점토 표면, 외부 드롭섀도 + 내부 inset 하이라이트로 말랑한 압출, radius xl(28px)의 둥근 모서리.',
    tags: ['light', 'pastel', 'rounded', 'depth', 'playful', 'organic', 'animated'],
    mood: { formality: 2, energy: 3, warmth: 3, density: 2, ornament: 3 },
    characteristics: {
      cornerRadius: 'round',
      borderWeight: 'none',
      shadow: 'soft',
    ...
    domains: ['marketing', 'kids', 'education', 'portfolio', 'social'],
    useWhen: [
      '친근하고 놀이적인 소비자 앱·랜딩에 말랑한 촉감을 주고 싶을 때 쓴다.',
      '키즈·교육처럼 부드럽고 안전한 인상이 필요할 때 쓴다.',
      '파스텔 톤과 두툼한 3D 표면으로 브랜드 개성을 드러낼 때 쓴다.',
      '버튼·카드에 눌러보고 싶은 촉각적 반응을 넣고 싶을 때 쓴다.',
    ],
    avoidWhen: [
      '정보 밀도 높은 대시보드·데이터 테이블에서 그림자 소음이 문제될 때 피한다.',
      '기업용·금융처럼 격식과 절제가 우선일 때 피한다.',
      '평면 구조와 강한 대비가 접근성상 필요할 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['neumorphism-soft-01', 'kawaii-pastel-01'],
  },
};
