...
export const frutigerAeroGlossyStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'FrutigerAero_Glossy_01',
    trendIndex: 13,
    family: 'nostalgia',
    priority: 'P3',
    summary: '스카이블루·그린·화이트 위 아쿠아 글로시 버튼과 투명 글라스 카드, 물·잎·하늘 자연 모티프의 2000s 낙관적 테크-자연 글로스.',
    tags: ['light', 'glossy', 'gradient', 'glass', 'rounded', 'vivid', 'retro', 'animated'],
    mood: { formality: 2, energy: 3, warmth: 2, density: 2, ornament: 4 },
    characteristics: {
      cornerRadius: 'round',
      borderWeight: 'thin',
      shadow: 'soft',
    ...
    domains: ['landing', 'marketing', 'healthcare', 'dashboard'],
    useWhen: [
      '2000년대 낙관적 테크-자연 감성의 밝은 랜딩·제품 소개를 만들 때 쓴다.',
      '가전·웰니스처럼 맑고 투명한 아쿠아 글로스 표면이 어울릴 때 쓴다.',
      '하늘·물·잎 그라디언트로 신선하고 친근한 인상을 주고 싶을 때 쓴다.',
      'Y2K 이후 레트로 노스탤지어를 살리고 싶을 때 쓴다.',
    ],
    avoidWhen: [
      '기업용 관리 UI·데이터 밀도 높은 대시보드에서 절제가 필요할 때 피한다.',
      '무광 미니멀·진지한 편집 톤이 요구될 때 피한다.',
      '광택·투명 표면이 텍스트 가독성을 해치는 고밀도 화면에서 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['glassmorphism-aurora-01', 'y2k-futurism-01', 'iridescent-chrome-01'],
  },
};
