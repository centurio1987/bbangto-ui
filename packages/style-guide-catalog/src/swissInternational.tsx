...
export const swissInternationalStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Swiss_International_01',
    trendIndex: 7,
    family: 'typographic-editorial',
    priority: 'P1',
    summary: '모듈러 그리드 + 비대칭 정렬 + 산세리프, 흑/백 + 단일 빨강, 각진 모서리·무그림자로 위계는 크기·굵기·위치로만.',
    tags: ['light', 'high-contrast', 'sharp', 'grid', 'asymmetric', 'typographic', 'geometric', 'minimal', 'flat'],
    mood: { formality: 4, energy: 2, warmth: 2, density: 3, ornament: 1 },
    characteristics: {
      cornerRadius: 'sharp',
      borderWeight: 'thin',
      shadow: 'none',
    ...
    domains: ['editorial', 'portfolio', 'marketing', 'creative-agency', 'docs'],
    useWhen: [
      '편집·포스터·타이포 주도 레이아웃을 그리드로 조직할 때 쓴다.',
      '고대비 흑백으로 명료함과 접근성을 최우선할 때 쓴다.',
      '크리에이티브 에이전시·포트폴리오처럼 절제된 세련미가 필요할 때 쓴다.',
      '장식을 배제하고 타이포 위계만으로 강약을 만들고 싶을 때 쓴다.',
    ],
    avoidWhen: [
      '따뜻하고 친근한·놀이적 개성이 필요할 때 피한다.',
      '풍부한 색·그라디언트·입체 질감으로 감성을 자극해야 할 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aaa',
    ...
    related: ['minimal-saas-01', 'bauhaus-geometric-01', 'editorial-magazine-01'],
  },
};
