...
export const shatteredGlassCinematicStyleGuide: StyleGuide = {
  ...
  meta: {
    ...
    priority: 'P2',
    summary: '딥 잉크 다크 면을 가로지르는 깨진/금 간 유리 + 시안↔마젠타↔라임 이리데센트 프리즘 굴절, fragile yet striking의 시네마틱 결정질 표면.',
    tags: ['dark', 'glass', 'gradient', 'neon', 'depth', 'serif', 'animated'],
    mood: { formality: 3, energy: 4, warmth: 2, density: 2, ornament: 4 },
    characteristics: {
      cornerRadius: 'soft',
      borderWeight: 'thin',
      shadow: 'glow',
    ...
    domains: ['portfolio', 'creative-agency', 'entertainment', 'marketing', 'landing'],
    useWhen: [
      '시네마틱 히어로·룩북·제품 쇼케이스에서 극적인 인상이 필요할 때 쓴다.',
      '깨진 유리·프리즘 굴절 같은 시각적 시그니처로 브랜드를 각인시키고 싶을 때 쓴다.',
      '어두운 배경 위 이리데센트 강조로 프리미엄·아방가르드 분위기를 낼 때 쓴다.',
      '포트폴리오·크리에이티브 에이전시 랜딩처럼 표현력이 우선일 때 쓴다.',
    ],
    avoidWhen: [
      '데이터 밀도 높은 대시보드·관리 UI처럼 가독성이 최우선일 때 피한다.',
      '본문 정보량이 많아 균열·굴절 장식이 오히려 방해될 때 피한다.',
      '라이트·미니멀 기업 톤이 필요할 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['glassmorphism-aurora-01', 'iridescent-chrome-01', 'darkluxe-editorial-01'],
  },
};
