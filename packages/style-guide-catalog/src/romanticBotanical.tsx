...
export const romanticBotanicalStyleGuide: StyleGuide = {
  ...
  meta: {
    ...
    family: 'nostalgia',
    priority: 'P3',
    summary: '파스텔 정원 위 화이트 핸드드로잉 꽃·잎·나비 라인아트, 세리프 디스플레이 + 휴머니스트 산세리프의 로맨틱 보태니컬 무드.',
    tags: ['pastel', 'light', 'serif', 'organic', 'rounded', 'airy', 'hand-drawn', 'animated'],
    mood: { formality: 2, energy: 2, warmth: 4, density: 2, ornament: 4 },
    characteristics: {
      cornerRadius: 'round',
      borderWeight: 'thin',
      shadow: 'soft',
    ...
    domains: ['marketing', 'ecommerce', 'portfolio', 'landing', 'creative-agency'],
    useWhen: [
      '봄 캠페인·브랜드 Hero처럼 로맨틱하고 자연스러운 무드가 필요할 때 쓴다.',
      '뷰티·코스메틱·굿즈 커머스에서 우아하고 감성적인 진열이 필요할 때 쓴다.',
      '무드보드·포트폴리오·뉴스레터·초대장에 장식적 정원 무드를 입힐 때 쓴다.',
      '파스텔 라인아트로 부드럽고 감성적인 브랜드 톤을 만들고 싶을 때 쓴다.',
    ],
    avoidWhen: [
      '정보 밀도 높은 대시보드·데이터 화면에서 파스텔 저대비가 가독성을 해칠 때 피한다.',
      '기업·핀테크처럼 포멀하고 강한 신뢰감이 우선일 때 피한다.',
      '강렬한 임팩트·고에너지 표현이 핵심일 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['scandi-warm-01', 'kawaii-pastel-01', 'heritage-folk-ornament-01'],
  },
};
