...
export const minimalSaasStyleGuide: StyleGuide = {
  ...
  visualMotif,
  meta: {
    displayName: 'Minimal_Saas_01',
    trendIndex: 6,
    family: 'flat-systematic',
    priority: 'P1',
    summary: '중립 그레이 + 단일 인디고 액센트, 얇은 보더·약한 그림자, 넉넉한 여백의 제품 UI.',
    tags: ['light', 'minimal', 'flat', 'airy', 'muted', 'serious', 'mono'],
    mood: { formality: 4, energy: 1, warmth: 2, density: 2, ornament: 1 },
    characteristics: {
      cornerRadius: 'soft',
      borderWeight: 'thin',
      shadow: 'soft',
    ...
    domains: ['saas', 'dev-tools', 'fintech', 'dashboard', 'docs'],
    useWhen: [
      '제품 대시보드·설정·데이터 밀도 높은 관리 UI를 만들 때 쓴다.',
      'B2B SaaS·개발자 도구처럼 신뢰감과 가독성이 우선일 때 쓴다.',
      '브랜드 색을 절제하고 콘텐츠에 집중시키고 싶을 때 쓴다.',
    ],
    avoidWhen: [
      '소비자 마케팅 랜딩에서 강한 개성·임팩트가 필요할 때 피한다.',
      '놀이·엔터·키즈처럼 표현적 에너지가 핵심일 때 피한다.',
    ],
    accessibility: {
      contrastIntent: 'aa',
    ...
    related: ['flat-material-01', 'swiss-international-01'],
  },
};
