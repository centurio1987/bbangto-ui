...
import { punkGrungeGraffitiStyleGuide } from '@centurio1987/bbangto-ui-style-guide-catalog';
import { makeCatalogStories } from './_catalogStory';

/**
 * Punk_Grunge_Graffiti_01 — 제록스 하프톤·찢긴 가장자리·스프레이/낙서 펑크 진 콜라주.
 * 6-leaf 카탈로그 구성요소는 공통 팩토리(makeCatalogStories)로 생성한다.
 */
const meta = {
  title: 'STYLE GUIDE CATALOG/Punk_Grunge_Graffiti_01',
  parameters: { layout: 'fullscreen', a11y: { test: 'todo' } },
} satisfies Meta;
export default meta;

const s = makeCatalogStories(punkGrungeGraffitiStyleGuide);
